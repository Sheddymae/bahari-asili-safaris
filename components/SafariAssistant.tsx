...
type AssistantCopy = { title: string; welcome: string; placeholder: string; quote: string; whatsapp: string; close: string; open: string; thinking: string; send: string; note: string };
...
const copy: Record<SupportedLocale, AssistantCopy> = {
  en: { title: 'Safari Assistant', welcome: 'Hello! I can help you plan a Kenya safari. Tell me where you would like to go, when you are travelling and how many people are joining.', placeholder: 'Ask about safaris, destinations or your trip...', quote: 'Request a tailored quotation', whatsapp: 'Need more information? Chat on WhatsApp', close: 'Close assistant', open: 'Open safari assistant', thinking: 'Thinking...', send: 'Send', note: 'Prices and availability are confirmed by the safari team.' },
  it: { title: 'Assistente Safari', welcome: 'Ciao! Posso aiutarti a pianificare un safari in Kenya. Dimmi dove vuoi andare, quando viaggi e quante persone siete.', placeholder: 'Chiedi di safari, destinazioni o del tuo viaggio...', quote: 'Richiedi un preventivo personalizzato', whatsapp: 'Hai bisogno di altre informazioni? Scrivici su WhatsApp', close: "Chiudi l'assistente", open: 'Apri assistente safari', thinking: 'Sto pensando...', send: 'Invia', note: 'Prezzi e disponibilità sono confermati dal team safari.' },
  fr: { title: 'Assistant Safari', welcome: 'Bonjour ! Je peux vous aider à planifier un safari au Kenya. Dites-moi où vous souhaitez aller, quand vous voyagez et combien vous êtes.', placeholder: 'Posez une question sur les safaris ou votre voyage...', quote: 'Demander un devis personnalisé', whatsapp: "Besoin de plus d'informations ? Contactez-nous sur WhatsApp", close: "Fermer l'assistant", open: "Ouvrir l'assistant safari", thinking: 'Réflexion...', send: 'Envoyer', note: 'Les prix et disponibilités sont confirmés par notre équipe safari.' },
  es: { title: 'Asistente de Safari', welcome: '¡Hola! Puedo ayudarte a planificar un safari en Kenia. Dime dónde quieres ir, cuándo viajas y cuántas personas sois.', placeholder: 'Pregunta sobre safaris, destinos o tu viaje...', quote: 'Solicitar un presupuesto personalizado', whatsapp: '¿Necesitas más información? Escríbenos por WhatsApp', close: 'Cerrar asistente', open: 'Abrir asistente de safari', thinking: 'Pensando...', send: 'Enviar', note: 'Los precios y la disponibilidad son confirmados por el equipo de safari.' },
  de: { title: 'Safari-Assistent', welcome: 'Hallo! Ich kann dir bei der Planung einer Kenia-Safari helfen. Sag mir, wohin du reisen möchtest, wann und mit wie vielen Personen.', placeholder: 'Frage zu Safaris, Reisezielen oder deiner Reise...', quote: 'Individuelles Angebot anfragen', whatsapp: 'Weitere Informationen? Über WhatsApp chatten', close: 'Assistent schließen', open: 'Safari-Assistent öffnen', thinking: 'Denke nach...', send: 'Senden', note: 'Preise und Verfügbarkeit werden vom Safari-Team bestätigt.' },
  ar: { title: 'مساعد السفاري', welcome: 'مرحباً! يمكنني مساعدتك في التخطيط لرحلة سفاري في كينيا. أخبرني بالوجهة والتاريخ وعدد المسافرين.', placeholder: 'اسأل عن رحلات السفاري أو وجهتك...', quote: 'طلب عرض سعر مخصص', whatsapp: 'تحتاج إلى مزيد من المعلومات؟ تواصل معنا عبر واتساب', close: 'إغلاق المساعد', open: 'فتح مساعد السفاري', thinking: 'جارٍ التفكير...', send: 'إرسال', note: 'يؤكد فريق السفاري الأسعار والتوافر.' },
  zh: { title: '野生动物之旅助手', welcome: '您好！我可以帮助您规划肯尼亚野生动物之旅。请告诉我目的地、出行日期和人数。', placeholder: '询问野生动物之旅、目的地或行程...', quote: '申请定制报价', whatsapp: '需要更多信息？通过 WhatsApp 联系我们', close: '关闭助手', open: '打开旅行助手', thinking: '思考中...', send: '发送', note: '价格和可用性由旅行团队确认。' },
  sw: { title: 'Msaidizi wa Safari', welcome: 'Habari! Naweza kukusaidia kupanga safari ya Kenya. Niambie unataka kwenda wapi, unasafiri lini na mtakuwa watu wangapi.', placeholder: 'Uliza kuhusu safari, maeneo au mipango yako...', quote: 'Omba bei maalum ya safari', whatsapp: 'Unahitaji maelezo zaidi? Zungumza nasi WhatsApp', close: 'Funga msaidizi', open: 'Fungua msaidizi wa safari', thinking: 'Nafikiria...', send: 'Tuma', note: 'Bei na upatikanaji vinathibitishwa na timu ya safari.' },
};
