    ...
    <>
      ...
      <main className="overflow-x-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10 lg:py-14">
          ...
          <div className="bg-foreground rounded-2xl p-8 sm:p-10 text-center"><h3 className="font-poppins font-bold text-2xl text-white mb-3">{cta.title}</h3><p className="font-inter text-white/70 text-sm mb-6 max-w-lg mx-auto">{cta.description}</p><Link href={`/booking?tour=${encodeURIComponent(excursion.id)}`} className="inline-flex items-center justify-center gap-2 bg-safari-500 hover:bg-safari-600 text-white font-poppins font-semibold text-sm px-8 py-3.5 rounded-xl transition-all hover:shadow-md">{ee.requestThisExcursion}</Link></div>
