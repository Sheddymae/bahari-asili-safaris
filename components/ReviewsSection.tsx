                ...
                {(canScrollPrev || canScrollNext) && (
                  <div className="flex items-center justify-center gap-3 mt-8">
                    <button
                      ...
                      className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-foreground hover:border-ocean-600 hover:text-ocean-700 disabled:opacity-30 disabled:hover:border-border disabled:hover:text-foreground transition-colors"
                    >
