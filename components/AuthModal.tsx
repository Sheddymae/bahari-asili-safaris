      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md overflow-hidden z-10">
        ...
        <div className="px-8 py-6">
            ...
            {(['signin', 'signup'] as Mode[]).map(m => (
              <button
                ...
                className={`flex-1 py-2 font-inter font-medium text-sm rounded-lg transition-all ${
                  mode === m ? 'bg-white text-ocean-700 shadow-sm' : 'text-muted-foreground hover:text-foreground'
                }`}
              >
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 border border-border rounded-xl py-3 font-inter font-medium text-foreground hover:bg-muted transition-all mb-4 disabled:opacity-50"
          >
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-border rounded-xl font-inter text-sm text-foreground outline-none focus:border-ocean-600 focus:ring-2 focus:ring-ocean-100 transition-all bg-muted"
                  />
                </div>
              </div>
            )}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-11 py-3 border border-border rounded-xl font-inter text-sm text-foreground outline-none focus:border-ocean-600 focus:ring-2 focus:ring-ocean-100 transition-all bg-muted"
                />
                <button
                  type="button"
            ...
            {error && (
              <div className="flex items-start gap-2 bg-[#ef4444]/10 border border-[#ef4444]/30 rounded-xl px-4 py-3">
            ...
            {success && (
              <div className="bg-[#0e7490]/10 border border-[#0e7490]/30 rounded-xl px-4 py-3">
                <p className="font-inter text-sm text-primary">{success}</p>
              </div>
            )}
            ...
            >
              ...
              ) : mode === 'signin' ? t.auth.signInTab : t.auth.signUpTitle}
            </button>
          </form>
        </div>
      </div>
