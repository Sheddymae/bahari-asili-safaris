      ...
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; color: #1f2937;">
        ...
        <div style="padding: 24px; background: #ffffff; border: 1px solid #e2e8f0;">
          ...
          <table style="width: 100%; border-collapse: collapse;">
            <tr><td style="padding: 6px 0; color: #64748b; font-size: 14px;">Name</td><td style="padding: 6px 0; font-weight: 600;">${fullName}</td></tr>
            <tr><td style="padding: 6px 0; color: #64748b; font-size: 14px;">Email</td><td style="padding: 6px 0;">${email}</td></tr>
            <tr><td style="padding: 6px 0; color: #64748b; font-size: 14px;">WhatsApp</td><td style="padding: 6px 0;">${whatsapp || "—"}</td></tr>
            <tr><td style="padding: 6px 0; color: #64748b; font-size: 14px;">Safari / Tour</td><td style="padding: 6px 0; font-weight: 600; color: #f97316;">${safariName}</td></tr>
            <tr><td style="padding: 6px 0; color: #64748b; font-size: 14px;">Arrival Date</td><td style="padding: 6px 0; font-weight: 600;">${arrivalDate}</td></tr>
            <tr><td style="padding: 6px 0; color: #64748b; font-size: 14px;">Adults</td><td style="padding: 6px 0;">${adults}</td></tr>
            <tr>
              <td style="padding: 6px 0; color: #64748b; font-size: 14px;">Bambini / Children</td>
              <td style="padding: 6px 0;">${childrenDisplay}</td>
            </tr>
            ${message ? `<tr><td style="padding: 6px 0; color: #64748b; font-size: 14px; vertical-align: top;">Message</td><td style="padding: 6px 0;">${message}</td></tr>` : ""}
          </table>
